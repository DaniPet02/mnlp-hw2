...
Your job is to evaluate the quality of a translation and Compile a report in CSV format containing the results of the qualitative analysis and the aggregate score for Archaic to Modern Italian Traslation. 
